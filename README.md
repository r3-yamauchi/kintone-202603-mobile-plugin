...
これは kintone モバイル版の新しいAPI（2026年3月リリース予定）の動作確認を行えるサンプルプラグインです。
ボトムシート、確認ボトムシート、通知メッセージ、ローディング表示の4つの新APIをテストできます。

アップデート情報: https://jp.kintone.help/k/ja/update/main/2026-03
...
- 4つのモバイルAPI用の動作確認ボタン:
  - **ボトムシート表示** ([kintone.mobile.createBottomSheet](https://jp.kintone.help/k/ja/update/main/2026-03#point9))
  - **確認ボトムシート表示** ([kintone.mobile.showConfirmBottomSheet](https://jp.kintone.help/k/ja/update/main/2026-03#point10))
  - **通知メッセージ表示** ([kintone.mobile.showNotification](https://jp.kintone.help/k/ja/update/main/2026-03#point11))
  - **ローディング表示** ([kintone.mobile.showLoading](https://jp.kintone.help/k/ja/update/main/2026-03#point11))
...
- **ボトムシートを表示**: `createBottomSheet(config)` を使って `title` と `body(Element)` を渡し、`show()` の結果文字列を表示します
...
- **通知メッセージを表示**: `showNotification(type, message)` 形式で `SUCCESS`/`INFO`/`ERROR` の3種類を順番に表示します
- **ローディングを表示**: `showLoading('VISIBLE')` で表示し、3秒後に `showLoading('HIDDEN')` で非表示にします
...
- [kintone.mobile.createBottomSheet()](https://jp.kintone.help/k/ja/update/main/2026-03#point9) - ボトムシートを作成
- [kintone.mobile.showConfirmBottomSheet()](https://jp.kintone.help/k/ja/update/main/2026-03#point10) - 確認ボトムシートを表示
- [kintone.mobile.showNotification()](https://jp.kintone.help/k/ja/update/main/2026-03#point11) - 通知メッセージを表示
- [kintone.mobile.showLoading()](https://jp.kintone.help/k/ja/update/main/2026-03#point11) - ローディングを表示
